...
<ion-app style="overflow:auto">
    <ion-menu side="end" id="menuContainer" menu-id="first" content-id="main">
          <ion-content>
            <ion-list>
              <ion-item href="http://localhost/pubCrawlFinal/home/where-is-the-pub-crawl">Home</ion-item>
    ...
    <ion-header>
        <ion-toolbar id="toolbar" color="white">
            ...
            <ion-buttons slot="start">
                <a id="main-logo" href="http://localhost/pubCrawlFinal/home/where-is-the-pub-crawl">
                    <img src="../imgs/logo.webp" alt="logo" height="100px" width="100px"/>
                </a>
            </ion-buttons>
    ...
    <ionic-content>
      ...
      <div id="FJB">
          <img src="../Findingg.png" width="50px" height="50px" id="find">
          <img src="../Joiningg.png" width="50px" height="50px" id="join">
          <img src="../Bookingg.png" width="50px" height="50px" id="book">
      </div>
      <div id="exp-fjb">
          <p id="paraO"><img src="../Findingg.png" width="50px" height="50px" id="find-m"><br/>The app provides exact real time information about where the nearest
          ...
          <p id="paraT"><img src="../Joiningg.png" width="50px" height="50px" id="join-m"><br/>Although many pub crawls begin at a certain time, you should feel free to join the crawl at any stage. Perhaps you’re running a bit late, live slightly outside
          ...
          <p id="paraTh"><img src="../Bookingg.png" width="50px" height="50px" id="book-m"><br/>If you wish, you can book a
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6><b>Where Is The Pub Crawl?</b></h6>
            <p class="text-justify">Each experience is carefully chosen by hand after being put through a rigorous procedure by our professionals to make sure that only the most pertinent and valuable ones are included. Our website is supported by cutting-edge technology and a committed crew that works hard to keep the process bug-free and provide the greatest experience for our clients from the very first click.</p>
          </div>
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              ...
              <li><a href="#city-head">Cities</a></li>
              <li><a href="https://south.tours/magazine/" target="_blank">Blog</a></li>
        ...
        <div class="copyright">
          <div class="col-md-8 col-sm-6 col-xs-12">
            <p class="copyright-text">Copyright &copy; 2023 All Rights Reserved by 
               <a href="https://south.tours/" target="_blank">South Tours</a>.
            </p>
          </div>
...
document.getElementById("about-t").style.marginTop = "4em";
