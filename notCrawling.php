...
<head>
    ...
    <link rel="stylesheet" href="/pubCrawlFinal/App.css" />
...
<body>
        ...
        <ion-header>
            <ion-toolbar id="toolbar" color="white">
                ...
                <ion-buttons slot="start">
                    <a id="main-logo" href="http://localhost/pubCrawlFinal/crawl">
                        <img src="/pubCrawlFinal/imgs/logo.webp" alt="logo" />
                    </a>
                </ion-buttons>
                        ...
                        $.ajax({
                            ...
                            success: (output) => {
                                ...
                                if (selectedCity == "Malaga") {
                                    $cityid = 1;
                                    window.location.href = "http://localhost/pubCrawlFinal/crawl/malaga-pub-crawl-malaga-bar-crawl-nightlife";
                                } else if (selectedCity == "Granada") {
                                    $cityid = 2;
                                    window.location.href = "http://localhost/pubCrawlFinal/crawl/granada-pub-crawl-granada-bar-crawl-nightlife";
                                }
                                //window.location.href = "http://localhost/pubCrawlFinal/malaga/malagapubcrawl";
                                //window.location.href = "http://localhost/pubCrawlFinal/granada/granadapubcrawl";
                            }
    ...
    <script src='App.js'>
         //if (window.location.reload() == true) {
             ...
             //location.href = "http://localhost/pubCrawlFinal/crawl"
         //}
    </script>
